...
{
    /// <inheritdoc />
    public partial class IninitiaCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AracPlaka = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2024, 9, 1, 13, 32, 21, 352, DateTimeKind.Local).AddTicks(6699), "admin@otoservissatis.tc", "admin", 1, "123456", "admin", "0850" });
