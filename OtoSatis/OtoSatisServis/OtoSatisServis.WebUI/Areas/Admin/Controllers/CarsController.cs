...
using OtoSatisServis.WebUI.Utils;

namespace OtoSatisServis.WebUI.Areas.Admin.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        //TODO: Ekle basınca eklemiyor tekrar bak
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditAsync(Arac arac, IFormFile? Resim1, IFormFile? Resim2, IFormFile? Resim3)
        {
